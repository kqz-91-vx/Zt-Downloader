...
export default function App() {
  ...
  // Safe Access to Current App
  const currentApp = results && results.length > 0 ? results[currentIndex] : null;
  ...
  const addToHistory = (data) => {
    setHistory(prev => {
        ...
        const exists = prev.find(item => item.package === data.package);
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      if (error.code === "ERR_NETWORK") {
          msg = "Backend not connected. Is server running on Port 3000?";
  ...
  return (
    <div className="min-h-screen p-6 flex flex-col items-center justify-center font-sans overflow-x-hidden relative bg-[#050505]">
      ...
      {/* HEADER */}
      <header className="mb-10 text-center flex flex-col items-center w-full max-w-2xl mx-auto z-10">
      ...
      {/* INPUT AREA - (Layout prop removed to prevent glitches) */}
      ...
      {/* RESULT CARD WITH NAVIGATION - Added Safe Guard */}
      <AnimatePresence mode="wait">
        {currentApp && !isLoading && (
          <motion.div
            key={currentApp.package + currentIndex}
            ...
            <div className="bg-[#0a0a0c] border border-white/10 rounded-2xl overflow-hidden relative">
              ...
              <div className="p-6 flex flex-col md:flex-row gap-6 items-start">
                ...
                <div className="w-24 h-24 sm:w-32 sm:h-32 bg-black rounded-2xl border border-white/5 p-2 shrink-0 shadow-lg mx-auto md:mx-0">
                  <img src={currentApp.thumbnail || 'https://via.placeholder.com/150'} alt="Icon" className="w-full h-full object-contain rounded-xl" />
                </div>
                ...
                <div className="flex-1 flex flex-col w-full">
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-6">
                      <div className="bg-white/5 p-2 rounded-lg text-center border border-white/5">
                          ...
                          <p className="text-white text-xs font-bold truncate">{currentApp.version}</p>
                      </div>
                      <div className="bg-white/5 p-2 rounded-lg text-center border border-white/5">
      ...
      <footer className="mt-16 text-center opacity-30 hover:opacity-100 transition-opacity pb-8 z-10 relative">
